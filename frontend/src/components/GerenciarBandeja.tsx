...
export function GerenciarBandeja() {
            ...
            <CardContent className="px-4 py-2">
                <div className="overflow-x-auto max-h-[400px]"> 
                    <table className="min-w-full table-auto border-separate border border-gray-300">
                        <thead>
                            <tr>
                                <th className="px-4 py-2 border-b text-center w-1/4">ID</th> {/* Diminuindo um pouco as larguras das colunas */}
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td className="px-4 py-2 border-x border-b text-center">4</td>
                            ...
                            <tr>
                                <td className="px-4 py-2 border-x border-b text-center">5</td>
